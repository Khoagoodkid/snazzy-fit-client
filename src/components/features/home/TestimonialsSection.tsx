...
export default function TestimonialsSection() {
  return (
    <motion.section 
      ...
      className="relative bg-gradient-to-br from-sky-50/40 via-cyan-50/30 to-teal-50/40 py-12 sm:py-16 md:py-20 overflow-hidden"
    >
      {/* Soft Gradient Blobs */}
      <div className="absolute top-1/4 left-1/3 w-64 sm:w-80 md:w-96 h-64 sm:h-80 md:h-96 bg-gradient-to-br from-sky-200/30 to-cyan-200/30 rounded-full blur-3xl opacity-40" />
      <div className="absolute bottom-1/4 right-1/3 w-80 sm:w-96 md:w-[450px] h-80 sm:h-96 md:h-[450px] bg-gradient-to-br from-teal-200/30 to-emerald-200/30 rounded-full blur-3xl opacity-40" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-3 sm:mb-4">What Our Clients Say</h2>
